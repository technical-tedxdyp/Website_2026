  ...
  return (
    <PublicLayout>
      ...
      <section className="w-full bg-black text-white flex flex-col items-center justify-center p-12 md:p-20 text-center min-h-[500px]">
        <div className="relative w-full max-w-md aspect-[440/355] mb-8 bg-[var(--cream)] p-4">
          <Image
        ...
        <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tight leading-tight">
          Meandering<br />
          <span className="text-[var(--brand-red)] text-2xl md:text-3xl tracking-[0.2em] font-pixel block my-2">In The</span>
          Mosaic
        </h1>
        ...
        <div className="flex gap-8 mt-10 font-pixel text-sm text-[var(--brand-red)] uppercase">
          <span>📅 TBA • 2026</span>
      ...
      <section id="theme" className="bg-black text-white px-6 md:px-24 py-24 border-b-2 border-neutral-900">
        <h3 className="font-pixel text-[var(--brand-red)] uppercase tracking-[0.3em] mb-8">The Theme</h3>
        <h2 className="text-5xl md:text-7xl font-black uppercase leading-[1.1] max-w-4xl tracking-tighter">
          ...
          <span className="text-[var(--brand-red)]">Mosaic.</span>
        </h2>

        <div className="mt-32 max-w-3xl space-y-24">
          <div className="flex flex-col md:flex-row gap-6 md:gap-16">
            <div className="font-pixel text-[var(--brand-red)]">01</div>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-16 md:ml-32">
            <div className="font-pixel text-[var(--brand-red)]">02</div>
            <div className="border-t border-neutral-800 pt-4 flex-1">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-16 md:ml-64">
            <div className="font-pixel text-[var(--brand-red)]">03</div>
            <div className="border-t border-neutral-800 pt-4 flex-1">
      ...
      <section className="bg-black text-white px-6 md:px-24 py-24 pb-48">
        <h3 className="font-pixel text-[var(--brand-red)] uppercase tracking-[0.3em] mb-6">What It Means</h3>
        <h2 className="text-4xl md:text-6xl font-black uppercase leading-[1.1] max-w-3xl tracking-tighter mb-24">
          A single path, wandering through a thousand <span className="text-[var(--brand-red)]">tiles.</span>
        </h2>

        <div className="flex flex-col lg:flex-row gap-16">
          {/* Left: Definitions */}
          <div className="w-full lg:w-1/3 space-y-12">
            <div className="border-l-4 border-[var(--brand-red)] pl-6">
            ...
            <p className="pt-8 text-gray-400 border-t border-neutral-800">
              Every speaker is a tile. Every talk, a fragment. <span className="text-[var(--brand-red)] font-bold">Hover the mosaic</span> to wander the fragments — and watch the whole picture come together.
            </p>
          </div>
