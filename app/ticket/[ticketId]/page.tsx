        ...
        return (
            <PublicLayout>
                <div className="min-h-screen bg-black flex items-center justify-center p-4">
                    <div className="text-center font-pixel text-brand uppercase tracking-widest text-xl">
                        Ticket Not Found
                    </div>
                </div>
            </PublicLayout>
        ...
        <PublicLayout>
            <div className="min-h-screen bg-black flex flex-col items-center py-24 px-6 md:px-24 border-t-2 border-neutral-900">
                ...
                <div className="w-full max-w-4xl text-center mb-16">
                    <h3 className="font-pixel text-brand uppercase tracking-[0.3em] mb-4">Admit One</h3>
                    <h1 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-none mb-6">
                        Your <span className="text-brand">Ticket</span>
                    </h1>
                ...
                {/* Ticket Container */}
                <div className="w-full max-w-4xl bg-black border-[4px] border-cream flex flex-col md:flex-row relative shadow-[12px_12px_0px_0px_#ff3300]">

                    {/* Left Block: Info */}
                    <div className="flex-1 p-8 md:p-12 md:border-r-[4px] border-cream border-b-[4px] md:border-b-0">
                            ...
                            <div className="border-l-2 border-brand pl-4">
                                ...
                                {ticket.selectedSessions?.map((session: any, idx: number) => (
                                    <div key={idx} className="mb-2">
                                        ...
                                        <span className="text-brand">{session.timeLabel} • Day {session.day}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="w-full md:w-80 bg-cream flex flex-col items-center justify-between p-8">
                        <div className="w-full text-center border-b-2 border-black pb-6 mb-6">
                            ...
                            <span className={`inline-block font-black text-2xl uppercase tracking-tighter ${ticket.checkedInAt ? 'text-blue-600' : 'text-brand'}`}>
                ...
                <div className="mt-12">
                    {ticket.pdfUrl && ticket.pdfUrl !== '#' ? (
                        <a
                            ...
                            className="font-pixel text-white hover:text-brand uppercase tracking-widest border-b-2 border-dashed border-gray-600 hover:border-brand pb-1 transition-colors"
                        >
